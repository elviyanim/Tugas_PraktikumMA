...
class ImageScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("IMAGE SCREEN"),backgroundColor: Colors.amber,),
      body: Column(children: [
      Center(child: Image.asset('assets/images/image_flutter.png', width: 200, height: 200)),

      const SizedBox(height: 16),

      const Center(child: Image( image: AssetImage('assets/images/image_flutter.png'), width: 200,height: 200,)),
